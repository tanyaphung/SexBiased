...
variants=outputs/obtain_GT_33animals/cutoff_${cutoff}/TM/cleaned/chr${i}_TM_cutoff_${cutoff}.GT.FORMAT

numAllele=10

out=outputs/compute_diversity/cutoff_${cutoff}/TM/TM_chr${i}_diversity_cutoff_${cutoff}.txt
