...
variants=outputs/obtain_GT_33animals/cutoff_${cutoff}/GW/cleaned/chr${i}_GW_cutoff_${cutoff}.GT.FORMAT

numAllele=12

out=outputs/compute_diversity/cutoff_${cutoff}/GW/GW_chr${i}_diversity_cutoff_${cutoff}.txt
