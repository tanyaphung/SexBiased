...
variants=outputs/obtain_GT_33animals/cutoff_${cutoff}/AW/cleaned/chr${i}_AW_cutoff_${cutoff}.GT.FORMAT

numAllele=12

out=outputs/compute_diversity/cutoff_${cutoff}/AW/AW_chr${i}_diversity_cutoff_${cutoff}.txt
