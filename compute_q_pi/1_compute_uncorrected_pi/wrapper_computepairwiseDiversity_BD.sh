...
variants=outputs/obtain_GT_33animals/cutoff_${cutoff}/BD/cleaned/chr${i}_BD_cutoff_${cutoff}.GT.FORMAT

numAllele=24

out=outputs/compute_diversity/cutoff_${cutoff}/BD/BD_chr${i}_diversity_cutoff_${cutoff}.txt
